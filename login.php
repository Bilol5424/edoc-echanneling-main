        ...
        if($result->num_rows==1){
            ...
            if ($utype=='p'){
                ...
                if ($checker->num_rows==1){
                    ...
                    Неверные учетные данные: некорректный email или пароль
                    </label>';
                }
...
Неверные учетные данные: некорректный email или пароль
            ...
            $error='<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">
            Мы не можем найти аккаунт с этим email.</label>';
        }
    ...
    <div class="container">
        <table border="0" style="margin: 0;padding: 0;width: 60%;">
            <tr>
                <td>
                    <p class="header-text">Добро пожаловать обратно!</p>
                </td>
            </tr>
        <div class="form-body">
            <tr>
                <td>
                    <p class="sub-text">Войдите, используя свои данные, чтобы продолжить.</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label-td">
                    <input type="email" name="useremail" class="input-text" placeholder="Адрес-Email" required>
                </td>
            </tr>
            <tr>
                <td class="label-td">
            ...
            <tr>
                <td>
                    <input type="submit" value="Вход" class="login-btn btn-primary btn">
                </td>
            </tr>
        </div>
            <tr>
