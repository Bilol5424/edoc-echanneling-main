            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-patient  menu-active menu-icon-patient-active">
                        <a href="patient.php" class="non-style-link-menu  non-style-link-menu-active"><div><p class="menu-text">Пациенты</p></a></div>
                    </td>
                </tr>
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Поиск по имени пациента или электронной почте" list="patient">&nbsp;&nbsp;
...
?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Все Пациенты (<?php echo $list11->num_rows; ?>)</p>
                    </td>
